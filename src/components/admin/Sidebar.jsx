...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 pt-14 md:pt-0 flex h-screen w-72.5 flex-col overflow-y-hidden text-white bg-[#24303f] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h1 className="text-white text-4xl text-center hidden md:block py-5">
            racyline
          </h1>
        </NavLink>
