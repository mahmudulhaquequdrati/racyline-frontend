...
function SingleMedicalRecord() {
  ...
  const handleSubmit = (e) => {
    ...
    return navigate("/user/complete-single-medical-record", {
      replace: true,
  ...
  return (
    <section className=" bg-primary py-16 px-4 border-[1px] border-[#EAEAEB]">
      <div className="max-w-[1140px] w-full mx-auto">
        <h1 className="text-2xl font-bold mb-5">
          Aggiungi nuova cartella clinica
        </h1>
