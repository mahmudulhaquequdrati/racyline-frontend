...
const Availabilities = () => {
  ...
  return (
    <section className="p-12 lg:p-20 flex justify-start items-center bg-[#FFF7EC] py-16 border-[1px] border-[#EAEAEB]">
      <div className="max-w-[638px] w-full  rounded-lg p-8 md:p-12 lg:p-16 bg-white">
